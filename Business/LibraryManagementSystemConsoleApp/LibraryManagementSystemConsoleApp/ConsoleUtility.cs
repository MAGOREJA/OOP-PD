...
namespace LibraryManagementSystemConsoleApp
{
    class ConsoleUtility
    {
        ...
        public static string adminmenu()
        {
            ...
            Console.WriteLine("5.Preview Feedbacks.");
            Console.WriteLine("6.See borrow history.");
            Console.WriteLine("7.View All the Users.");
        ...
        public static string student()
        {
            ...
            Console.WriteLine("4.View list of borrowed books.");
            Console.WriteLine("5.Enter name of book to return.");
            Console.WriteLine("6.Give Feedback or Complaint.Borrow a book.");
            Console.WriteLine("7.View list of borrowed books.");
            Console.WriteLine("8.View Fine.");
            Console.WriteLine("9.Change My Password.");
            Console.WriteLine("10.About Library.");
            Console.WriteLine("11.Credentials page.");
            Console.WriteLine();
            Console.Write("Select the option: ");
